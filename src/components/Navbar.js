          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" 
              className={`px-3 py-2 text-md font-medium rounded-lg transition-all duration-300 ${
                pathname === '/' 
                  ? (scrolled || isHovered) ? 'bg-gray-100 text-gray-900' : 'bg-white/20 text-white' 
                  : (scrolled || isHovered) ? 'hover:bg-gray-50' : 'hover:bg-white/10'
              }`}>
              Home
            </Link>
            <Link href="/gallery" 
          ...
          <div className="md:hidden flex items-center">
            <button 
              ...
              className={`inline-flex items-center justify-center p-2 rounded-md focus:outline-none transition-colors ${
                scrolled || isHovered ? 'hover:bg-gray-100' : 'hover:bg-white/10'
              }`}
            >
